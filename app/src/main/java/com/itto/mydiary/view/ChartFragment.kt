...
import com.itto.mydiary.databinding.Fragment3Binding
...
class ChartFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        mBinding = Fragment3Binding.inflate(inflater, container, false)
        initUI()
    ...
    private fun initUI(){
        ...
        val legend1 = chart.legend
        legend1.isEnabled = false
        ...
        val legend3 = chart3.legend
        legend3.isEnabled = false

        val xAxis3 = chart3.xAxis
